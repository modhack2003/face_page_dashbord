...
const Pages = ({ accessToken }) => {
  ...
  return (
    <div className='mt-6 w-full max-w-md mx-auto'>
      <h2 className='text-lg sm:text-xl font-semibold mb-4 text-gray-800'>Select a Page:</h2>
      ...
      {selectedPage && (
        <div className='mt-8 bg-gray-50 p-2 rounded-lg shadow-md'>
          <h2 className='text-lg sm:text-xl font-semibold mb-4 text-gray-800'>Insights for {selectedPage.name}:</h2>
          {loadingInsights ? (
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4'>
              <div className='bg-white p-4 rounded-lg shadow'>
                <h3 className='text-sm sm:text-base font-medium text-gray-700'>Followers</h3>
              ...
              <div className='bg-white p-4 rounded-lg shadow'>
                <h3 className='text-sm sm:text-base font-medium text-gray-700'>Impressions (Day)</h3>
                <p className='mt-2 text-xl sm:text-2xl font-bold text-blue-600'>
              ...
              <div className='bg-white p-4 rounded-lg shadow'>
                <h3 className='text-sm sm:text-base font-medium text-gray-700'>Impressions (Week)</h3>
                <p className='mt-2 text-xl sm:text-2xl font-bold text-blue-600'>
              ...
              <div className='bg-white p-4 rounded-lg shadow'>
                <h3 className='text-sm sm:text-base font-medium text-gray-700'>Impressions (28 Days)</h3>
                <p className='mt-2 text-xl sm:text-2xl font-bold text-blue-600'>
              ...
              <div className='bg-white p-4 rounded-lg shadow'>
                <h3 className='text-sm sm:text-base font-medium text-gray-700'>Reactions</h3>
                <p className='mt-2 text-xl sm:text-2xl font-bold text-blue-600'>
